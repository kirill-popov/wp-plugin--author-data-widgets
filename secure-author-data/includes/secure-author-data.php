...
class Secure_Author_Data {
	...
	public function __construct() {
		if ( defined( 'SECURE_AUTHOR_DATA_VERSION' ) ) {
			$this->version = SECURE_AUTHOR_DATA_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'secure-author-data';
	 ...
	 *
	 * - Secure_Author_Data_Loader. Orchestrates the hooks of the plugin.
	...
	private function load_widgets() {
		$plugin_widgets_loader = new Secure_Author_Data_Widgets_Loader();

		$this->loader->add_action('widgets_init', $plugin_widgets_loader, 'register_new_widgets');
	}
